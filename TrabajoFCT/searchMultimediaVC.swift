...
class ViewControllerDeBuscar: UIViewController {
...
extension ViewControllerDeBuscar: UICollectionViewDelegate,UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
